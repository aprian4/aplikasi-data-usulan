    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div>
                    <a href="<?= base_url('karpeg/detail_karpeg/' . $id_usulan); ?>">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($berkas_sp != null) { ?>
                                            ...
                                            <!-- Modal -->
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/hapus'); ?>'>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/suratpengantar'); ?>' enctype='multipart/form-data'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/skcpns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/skpns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/sttpp'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($berkas_foto != null) { ?>
                                            ...
                                            <form method='post' action='<?php echo base_url('karpeg/crud_upload/fotopns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranx != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karpeg/crud_upload/lampiranx'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranxi != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karpeg/crud_upload/lampiranxi'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_kehilangan != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karpeg/crud_upload/kehilangan'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
