            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Modal -->
                        <form id="form-tambah_karpeg_baru">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select class="custom-select" name='jenis_usulan' required>
                                                ...
                                                <option value="karpeg_baru">Pembuatan Kartu Pegawai (Karpeg)</option>
                                                <option value="karpeg_pengganti">Pembuatan Kartu Pegawai (Karpeg) Pengganti Karena Hilang</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-karpeg" style="font-size: 15px;" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($usulan as $r) : ?>
                                        <?php if (($r['jenis_usulan'] == 'karpeg_baru' || $r['jenis_usulan'] == 'karpeg_pengganti')) : ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td>
                                                    <?= $r['kode_usulan'];; ?>
                                                ...
                                                <td>
                                                    <?php if ($r['jenis_usulan'] == 'karpeg_baru') {
                                                        echo "Baru";
                                                    } else {
                                                        echo "Pengganti";
                                                    } ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a href="<?= base_url('karpeg/detail_karpeg/' . $r['id']); ?>" class="dropdown-item">
                                                                ...
                                                                <div class="dropdown-divider"></div>
                                                                <form action="<?= base_url('karpeg/crud_usulan_karpeg/hapus'); ?>" method="post">
                                                        ...
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('karpeg/crud_usulan_karpeg/ubahstatus'); ?>">
                                                ...
                                                <?php } else if ($r['status_usulan'] == 2) { ?>
                                                    <td>
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a href="<?= base_url('karpeg/riwayat/' . $r['id']); ?>" class="dropdown-item">
                                                        ...
                                                        <form method="POST" action="<?= base_url('karpeg/crud_usulan_karpeg/ubahstatus2'); ?>">
