                ...
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-riwayat_karpeg" style="font-size: 13px;" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                        <th scope="col">NIP</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($usulan['status_usulan'] == 2) { ?>
                                                        <a style="color:#fff" class="lihat btn btn-primary btn-sm" href="<?= base_url('karpeg/riwayat_berkas/' . $lu['nip'] . '/' . $usulan['id'] . '/' . $usulan['jenis_usulan']); ?>" role="button"><i class="fas fa-file"></i> Berkas</a>
                                                    <?php } else { ?>
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="<?= base_url('karpeg/riwayat_berkas/' . $lu['nip'] . '/' . $usulan['id'] . '/' . $usulan['jenis_usulan']); ?>"><i class="fas fa-file"></i> Berkas</a>
                                                            </div>
                                                        </div>
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('karpeg/crud_riwayat/kirimnotifikasi'); ?>">
                                                        ...
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('karpeg/crud_riwayat/datakarpeg'); ?>" enctype='multipart/form-data'>
                                                            <div class="modal fade" id="modal-dataKarpeg<?= $i ?>" tabindex="-1" aria-labelledby="dataKarpegModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content col-sm-12">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title text-center" id="dataKarpegModalLabel">Data Kartu Pegawai</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div id="formDisetujui">
                                                                                <label>Scan Kartu Pegawai (Format file .pdf | max. 2MB)</label><br>
                                                                                <?php $path_berkas = null; ?>
                                                                                <?php foreach ($berkas as $bks) {
                                                                                    $nama_berkas = "SCAN_KARPEG_" . $lu['nip'];
                                                                                ...
                                                                                <?php if ($path_berkas != null) { ?>
                                                                                    ...
                                                                                    <a style="color:#fff" class="lihat btn btn-danger btn-sm" href="<?= base_url('karpeg/hapus_berkas_karpeg/' . $id_berkas . '/' . $usulan['id']); ?>" role="button"><i class="fas fa-times-circle"></i> Batal</a>
                                                                                <?php } else { ?>
                                                        ...
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('karpeg/crud_tandaterima'); ?>" enctype='multipart/form-data'>
