                ...
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select class="custom-select" name='jenis_usulan' required>
                                                ...
                                                <option value="kartu_tanda_pengenal_baru">Pembuatan Id Card Baru</option>
                                                <option value="kartu_tanda_pengenal_pengganti">Pembuatan Id Card Pengganti Karena Hilang</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-idcard" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($usulan as $r) : ?>
                                        <?php if (($r['jenis_usulan'] == 'kartu_tanda_pengenal_baru') || ($r['jenis_usulan'] == 'kartu_tanda_pengenal_pengganti')) : ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td>
                                                    <?= $r['kode_usulan'];; ?>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Modal -->
                                                    <form id="form-hapus_usulan_idcard">
                                                    ...
                                                    <!-- Modal -->
                                                    <form id="form-edit_status_usulan_idcard">
