            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Modal -->
                        <form id="form-tambah_idcard_baru">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select class="custom-select" name='jenis_usulan' required>
                                                ...
                                                <option value="idcard_baru">Pembuatan Kartu Tanda Pengenal (Idcard)</option>
                                                <option value="idcard_pengganti">Pembuatan Kartu Tanda Pengenal (Idcard) Pengganti Karena Hilang</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-idcard" style="font-size: 15px;" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($usulan as $r) : ?>
                                        <?php if (($r['jenis_usulan'] == 'idcard_baru' || $r['jenis_usulan'] == 'idcard_pengganti')) : ?>
                                            <tr>
                                                <th scope="row"><?= $i; ?></th>
                                                <td>
                                                    <?= $r['kode_usulan'];; ?>
                                                ...
                                                <td>
                                                    <?php if ($r['jenis_usulan'] == 'idcard_baru') {
                                                        echo "Baru";
                                                    } else {
                                                        echo "Pengganti";
                                                    } ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a href="<?= base_url('idcard/detail_idcard/' . $r['id']); ?>" class="dropdown-item">
                                                                ...
                                                                <div class="dropdown-divider"></div>
                                                                <form action="<?= base_url('idcard/crud_usulan_idcard/hapus'); ?>" method="post">
                                                        ...
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('idcard/crud_usulan_idcard/ubahstatus'); ?>">
                                                ...
                                                <?php } else if ($r['status_usulan'] == 2) { ?>
                                                    <td>
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a href="<?= base_url('idcard/riwayat/' . $r['id']); ?>" class="dropdown-item">
                                                        ...
                                                        <form method="POST" action="<?= base_url('idcard/crud_usulan_idcard/ubahstatus2'); ?>">
