                                        ...
                                        <?php foreach ($detail_usulan as $lu) : ?>
                                            <tr>
                                                ...
                                                <?php if ($usulan['status_usulan'] == 3) { ?>
                                                    ...
                                                    <td>
                                                        <?php if ($lu['status_karsu'] != null) {
                                                            if ($lu['status_karsu'] == 1) {
                                                                echo "Diterima";
                                                            } else if ($lu['status_karsu'] == 2) {
                                                                echo "Ditolak";
                                                            }
                                                        } ?>
                                                    </td>
                                                                    ...
                                                                    <div class="modal-content col-sm-12">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div id="statusKarsu">
                                                                                ...
                                                                                <input type="radio" id="status_karsu1" name="status_karsu" value="1" <?= ($lu['status_karsu'] == 1) ? "checked" : ""; ?>> Disetujui</input><br>
                                                                                <input type="radio" id="status_karsu2" name="status_karsu" value="2" <?= ($lu['status_karsu'] == 2) ? "checked" : ""; ?>> Ditolak</input>
                                                                                <input type="text" name="id_usulan" value="<?= $usulan['id']; ?>" hidden>
                                                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
