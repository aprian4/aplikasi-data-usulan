            ...
            <div class="col-12 col-sm-12 col-lg-12">
                ...
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <div class=" mb-3" align="right"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambahdataModal"><i class="fas fa-user-plus"> Tambah Suami</i></button>
