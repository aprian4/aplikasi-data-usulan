                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karsu/crud_upload/skcpns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karsu/crud_upload/skpns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karsu/crud_upload/sttpp'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($berkas_foto != null) { ?>
                                            ...
                                            <form method='post' action='<?php echo base_url('karsu/crud_upload/fotopns'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranx != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karsu/crud_upload/lampiranx'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranxi != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karsu/crud_upload/lampiranxi'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_kehilangan != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karsu/crud_upload/kehilangan'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
