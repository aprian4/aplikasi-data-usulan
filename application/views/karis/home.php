                ...
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select class="custom-select" name='jenis_usulan' required>
                                                ...
                                                <option value="karis_baru">Pembuatan Id Card Baru</option>
                                                <option value="karis_pengganti">Pembuatan Id Card Pengganti Karena Hilang</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-karis" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                        ...
                                        <?php if (($r['jenis_usulan'] == 'karis_baru') || ($r['jenis_usulan'] == 'karis_pengganti')) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Modal -->
                                                    <form id="form-hapus_usulan_karis">
                                                    ...
                                                    <!-- Modal -->
                                                    <form id="form-edit_status_usulan_karis">
