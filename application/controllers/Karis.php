...
class Karis extends CI_Controller
{
    ...
    public function home()
    {
        ...
        $this->load->view('karis/home', $data);
        $this->load->view('templates/footer');
    }


    public function detail_karis($id)
    {
        ...
        foreach ($data['detail_usulan'] as $lu) {
            ...
            if ($data['usulan']['jenis_usulan'] == "karis_baru") {
                $berkas1 = "PENGANTAR_KARIS_BARU_" . $lu['nip'];
            } else if ($data['usulan']['jenis_usulan'] == "karis_pengganti") {
                $berkas1 = "PENGANTAR_KARIS_PENGGANTI_" . $lu['nip'];
                $berkas6 = 'LAMPIRAN_X_KARIS_' . $lu['nip'];
                $berkas7 = 'LAMPIRAN_XI_KARIS_' . $lu['nip'];
                $berkas8 = 'KEHILANGAN_KARIS_' . $lu['nip'];
            }
            ...
            foreach ($berkas_perusulan as $bks) {
                ...
                if ($data['usulan']['jenis_usulan'] == "karis_pengganti") {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('karis/detail_karis', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function riwayat($id)
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('karis/riwayat', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function riwayat_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        if ($jenis_usulan == "karis_baru") {
            $namaberkas_sp = "PENGANTAR_KARIS_BARU_" . $nip;
        } else if ($jenis_usulan == "karis_pengganti") {
            $namaberkas_sp = "PENGANTAR_KARIS_PENGGANTI_" . $nip;
            $namaberkas_lampiranx = "LAMPIRAN_X_KARIS_" . $nip;
            $namaberkas_lampiranxi = "LAMPIRAN_XI_KARIS_" . $nip;
            $namaberkas_kehilangan = "KEHILANGAN_KARIS_" . $nip;
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('karis/riwayat_berkas', $data);
        $this->load->view('templates/footer');
    }

    public function crud_usulan_karis($aksi)
    {
    ...
    public function crud_usulan_detail_karis($aksi = null, $nip = null)
    {
        if ($aksi == 'hapus') {
            ...
            if ($this->db->where('nip', $nip)->where('kode_usulan', $kode_usulan)->delete('detail_usulan')) {
                ...
                redirect((base_url('karis/detail_karis/') . $id_usulan));
            } else {
    ...
    public function upload_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        foreach ($detail_usulan as $lu) {
            if ($jenis_usulan == "karis_baru") {
                $berkas1 = "PENGANTAR_KARIS_BARU_" . $nip;
            } else if ($jenis_usulan == "karis_pengganti") {
                $berkas1 = "PENGANTAR_KARIS_PENGGANTI_" . $nip;
                $berkas6 = "LAMPIRAN_X_KARIS_" . $nip;
                $berkas7 = "LAMPIRAN_XI_KARIS_" . $nip;
                $berkas8 = "KEHILANGAN_KARIS_" . $nip;
            }
            $berkas2 = 'SK_CPNS_' . $lu['nip'];
            $berkas3 = 'SK_PNS_' . $lu['nip'];
            $berkas4 = 'STTPP_' . $lu['nip'];
            ...
            foreach ($berkas_perusulan as $bks) {
                ...
                if ($jenis_usulan == "karis_pengganti") {
                    if ($bks['nama_berkas'] == $berkas6) {
                        $sb6 = "Lengkap";
                    }
                    if ($bks['nama_berkas'] == $berkas7) {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('karis/upload_berkas', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function crud_riwayat($pg)
    {
        if ($pg == "datakaris") {
            ...
            if ($status_kartu == 1) {
                ...
                // load view 
                redirect((base_url('karis/riwayat/') . $id_usulan));
            ...
            $message = "Yth.  " . $gender . " " . $nama_lengkap . "," . "%0D%0A" . "Kartu Istri (KARIS) anda sudah selesai dicetak. Silahkan untuk mengambilnya di BKPP. Kami juga telah mengirim softcopy/ scan kartu istri (KARIS) anda melalui email anda. %0D%0A%0D%0A" . "Manajemen Kinerja - BKPP Tangsel";
            ...
            $subject = "Pemberitahuan Kartu Istri (KARIS)";
            $message =  "Yth.  " . $gender . " " . $nama_lengkap . ",<br> Kartu Istri (KARIS) anda sudah selesai dicetak. Silahkan untuk mengambilnya di BKPP. Kami juga telah melampirkan softcopy/ scan kartu istri (KARIS) anda. <br><br> Manajemen Kinerja - BKPP Tangsel";
    ...
    public function hapus_berkas_karis($id_berkas = null, $id_usulan = null)
    {
        if ($this->db->where('id', $id_berkas)->delete('berkas')) {
    ...
    public function crud_upload($pg)
    {
        if ($pg == 'hapus') {
            ...
            if ($this->db->delete('berkas', ['id' => $id_berkas])) {
                redirect((base_url('karis/upload_berkas/') . $nip . '/' . $id_usulan . '/' . $jenis_usulan));
            }
        }
        ...
        if ($pg == 'suratpengantar') {
            ...
            $namaberkas = null;
            if ($jenis_usulan == "karis_baru") {
                $namaberkas = "PENGANTAR_KARIS_BARU_" . $nip;
            } else {
                $namaberkas = "PENGANTAR_KARIS_PENGGANTI_" . $nip;
            }
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_X_KARIS_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_XI_KARIS_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "KEHILANGAN_KARIS_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
