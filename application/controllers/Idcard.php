...
class Idcard extends CI_Controller
{
    ...
    public function detail_idcard($id)
    {
        ...
        foreach ($data['detail_usulan'] as $lu) {
            ...
            if ($data['usulan']['jenis_usulan'] == "idcard_baru") {
                $berkas1 = "PENGANTAR_IDCARD_BARU_" . $lu['nip'];
            } else if ($data['usulan']['jenis_usulan'] == "idcard_pengganti") {
                $berkas1 = "PENGANTAR_IDCARD_PENGGANTI_" . $lu['nip'];
                $berkas6 = 'LAMPIRAN_X_IDCARD_' . $lu['nip'];
                $berkas7 = 'LAMPIRAN_XI_IDCARD_' . $lu['nip'];
                $berkas8 = 'KEHILANGAN_IDCARD_' . $lu['nip'];
            }
            ...
            foreach ($berkas_perusulan as $bks) {
                ...
                if ($data['usulan']['jenis_usulan'] == "idcard_pengganti") {
    ...
    public function riwayat($id)
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('idcard/riwayat', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function riwayat_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        if ($jenis_usulan == "idcard_baru") {
            $namaberkas_sp = "PENGANTAR_IDCARD_BARU_" . $nip;
        } else if ($jenis_usulan == "idcard_pengganti") {
            $namaberkas_sp = "PENGANTAR_IDCARD_PENGGANTI_" . $nip;
            $namaberkas_lampiranx = "LAMPIRAN_X_IDCARD_" . $nip;
            $namaberkas_lampiranxi = "LAMPIRAN_XI_IDCARD_" . $nip;
            $namaberkas_kehilangan = "KEHILANGAN_IDCARD_" . $nip;
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('idcard/riwayat_berkas', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function upload_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        foreach ($detail_usulan as $lu) {
            if ($jenis_usulan == "idcard_baru") {
                $berkas1 = "PENGANTAR_IDCARD_BARU_" . $nip;
            } else if ($jenis_usulan == "idcard_pengganti") {
                $berkas1 = "PENGANTAR_IDCARD_PENGGANTI_" . $nip;
                $berkas6 = "LAMPIRAN_X_IDCARD_" . $nip;
                $berkas7 = "LAMPIRAN_XI_IDCARD_" . $nip;
                $berkas8 = "KEHILANGAN_IDCARD_" . $nip;
            }
            $berkas2 = 'SK_CPNS_' . $lu['nip'];
            $berkas3 = 'SK_PNS_' . $lu['nip'];
            $berkas4 = 'STTPP_' . $lu['nip'];
            ...
            foreach ($berkas_perusulan as $bks) {
                ...
                if ($jenis_usulan == "idcard_pengganti") {
                    if ($bks['nama_berkas'] == $berkas6) {
                        $sb6 = "Lengkap";
                    }
                    if ($bks['nama_berkas'] == $berkas7) {
    ...
    public function crud_riwayat($pg)
    {
        if ($pg == "dataidcard") {
            ...
            if ($status_kartu == 1) {
                ...
                // load view 
                redirect((base_url('idcard/riwayat/') . $id_usulan));
            ...
            $message = "Yth.  " . $gender . " " . $nama_lengkap . "," . "%0D%0A" . "Kartu Tanda Pengenal (IDCARD) anda sudah selesai dicetak. Silahkan untuk mengambilnya di BKPP. Kami juga telah mengirim softcopy/ scan kartu tanda pengenal (IDCARD) anda melalui email anda. %0D%0A%0D%0A" . "Manajemen Kinerja - BKPP Tangsel";
            ...
            $subject = "Pemberitahuan Kartu Tanda Pengenal (IDCARD)";
            $message =  "Yth.  " . $gender . " " . $nama_lengkap . ",<br> Kartu Tanda Pengenal (IDCARD) anda sudah selesai dicetak. Silahkan untuk mengambilnya di BKPP. Kami juga telah melampirkan softcopy/ scan kartu tanda pengenal (IDCARD) anda. <br><br> Manajemen Kinerja - BKPP Tangsel";
    ...
    public function hapus_berkas_idcard($id_berkas = null, $id_usulan = null)
    {
    ...
    public function crud_upload($pg)
    {
        if ($pg == 'hapus') {
            ...
            if ($this->db->delete('berkas', ['id' => $id_berkas])) {
                redirect((base_url('idcard/upload_berkas/') . $nip . '/' . $id_usulan . '/' . $jenis_usulan));
            }
        }
        ...
        if ($pg == 'suratpengantar') {
            ...
            if ($jenis_usulan == "idcard_baru") {
                ...
                $namaberkas = "PENGANTAR_IDCARD_PENGGANTI_" . $nip;
            }
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_X_IDCARD_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_XI_IDCARD_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "KEHILANGAN_IDCARD_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
